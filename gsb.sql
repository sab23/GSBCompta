...
--
-- Hôte : mysql
-- Généré le : ven. 30 avr. 2021 à 15:25
...
('a131', '202011', 1, '50.00', '2020-11-18', 'CR'),
('a17', '202101', 2, '150.00', '2021-01-15', 'CR');
...
INSERT INTO `lignefraishorsforfait` (`id`, `idutilisateur`, `mois`, `libelle`, `date`, `montant`, `justificatif`) VALUES
(18, 'a131', '202011', 'restaurant', '2020-11-15', '60.00', NULL),
(19, 'a17', '202101', 'invitation restaurant client', '2021-01-10', '130.00', NULL);
...
ALTER TABLE `lignefraishorsforfait`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idutilisateur` (`idutilisateur`,`mois`) USING BTREE;
...
--
ALTER TABLE `fichefrais`
  ADD CONSTRAINT `fichefrais_fk_1` FOREIGN KEY (`idEtat`) REFERENCES `etat` (`id`),
  ADD CONSTRAINT `fichefrais_fk_2` FOREIGN KEY (`idutilisateur`) REFERENCES `utilisateur` (`id`);

--
-- Contraintes pour la table `lignefraisforfait`
--
ALTER TABLE `lignefraisforfait`
  ADD CONSTRAINT `fk_ligne_ff` FOREIGN KEY (`idFraisForfait`) REFERENCES `fraisforfait` (`id`),
  ADD CONSTRAINT `fk_ligne_ff_utilisateur` FOREIGN KEY (`idutilisateur`) REFERENCES `utilisateur` (`id`);
